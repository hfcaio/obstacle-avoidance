...
(cl:defmethod cl:initialize-instance :after ((m <Points>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Points)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacle_avoidance-msg:<Points> is deprecated: use obstacle_avoidance-msg:Points instead.")))
