...
(cl:defmethod cl:initialize-instance :after ((m <Points>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Points)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacleavoidance-msg:<Points> is deprecated: use obstacleavoidance-msg:Points instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Points>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacleavoidance-msg:points-val is deprecated.  Use obstacleavoidance-msg:points instead.")
  (points m))
